...
#define CM36686_PROXIMITY_THDL_DEFAULT  	(15)
#define CM36686_PROXIMITY_THDH_DEFAULT  	(34)
#define CM36686_PROXIMITY_INF_DEFAULT  		(4)
#define CM36686_PROXIMITY_AUTOK_MIN  		(3)
#define CM36686_PROXIMITY_AUTOK_MAX  		(50)
#define CM36686_LIGHT_200LUX_DEFAULT		(647)
#define CM36686_LIGHT_1000LUX_DEFAULT		(3245)
